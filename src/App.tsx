    ...
    return {
      viewportConfigurer: async (vp: ScreenViewport) => {
        ...
        const displacementMarkers = [
          ...
          new DisplacementSensorMarker(new Point3d(-0.5, 1.4, 0.25), { x: 40, y: 40 }, "Virtual Sensor 2", () => setShowVideo(true)),
          new DisplacementSensorMarker(new Point3d(-0.5, 2, 0.25), { x: 40, y: 40 }, "Virtual Sensor 3", () => setShowVideo(true)),
        ];
